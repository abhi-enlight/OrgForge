 ...
 *
 * `ORGFORGE_UNIFIED_FRONTEND` is the CANARY gate: when `on`, the unified app's
 ...
 */
export const ORGFORGE_UNIFIED_FRONTEND = process.env.NEXT_PUBLIC_ORGFORGE_UNIFIED_FRONTEND === 'on';
