import { applyDeterministicOverrides } from './overrides';

export interface StubClassificationResult {
 ...
 */
export function classifyWithStub(message: string): StubClassificationResult {
