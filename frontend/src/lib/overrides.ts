 ...
 * (`stubClassifier.ts`). Kept dependency-free so the stub (and the web client
 ...
 *
 * @param message - the raw user prompt
 * @param modelCapability - classifier output (advisory)
 * @returns the override, or null
 */
